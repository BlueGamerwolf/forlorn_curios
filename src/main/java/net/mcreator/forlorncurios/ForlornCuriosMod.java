 ...
 *
 */
package net.mcreator.forlorncurios;
...
@Mod("forlorn_curios")
public class ForlornCuriosMod {
	public static final Logger LOGGER = LogManager.getLogger(ForlornCuriosMod.class);
	public static final String MODID = "forlorn_curios";
